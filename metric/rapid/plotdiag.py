...
from metric.rapid import observations
...
def plot_streamfunctions(config, trans, name='simulated', basename='', obs=None,lw=4):
...
def plot_streamfunction_hovmollers(config, trans, name='simulated', basename='', obs=None):
...
def plot_zonal_mean_temperature(config, trans, name='simulated', basename='', obs=None,lw=4):
...
def plot_fc_transport_profile(config, trans, name='simulated', basename='', obs=None,lw=4):
...
def plot_transport_profile(config, trans, name='simulated', basename='', obs=None,lw=4):
...
def plot_volume_components(config, trans, basename='', name='simulated', obs_vol=None, obs_fc=None,lw=4):
...
def plot_moc_vs_oht(config, trans, basename='', name='simulated', obs_vol=None, obs_oht=None):
...
def plot_vol_vs_heat_transports(config, trans, basename='', name='simulated', obs_vol=None, obs_oht=None):
...
def plot_geometric_heat_components(config, trans, basename='', name='simulated', obs=None,lw=4):
...
def plot_rapid_heat_components(config, trans, basename='', name='simulated', obs=None,lw=4):
...
def plot_moc_vs_oft(config, trans, basename='', name='simulated', obs_vol=None, obs_oft=None):
...
def plot_vol_vs_fw_transports(config, trans, basename='', name='simulated', obs_vol=None, obs_oft=None):
...
def plot_geometric_fw_components(config, trans, basename='', name='simulated', obs=None,lw=4):
...
def plot_rapid_fw_components(config, trans, basename='', name='simulated', obs=None,lw=4):
...
def plot_diagnostics(config, trans):
    ...
    obs_sf_f = utils.get_config_opt(config, 'observations', 'streamfunctions')
    obs_fc_f = utils.get_config_opt(config, 'observations', 'florida_current')
    obs_vol_f = utils.get_config_opt(config, 'observations', 'volume_transports')
    obs_oht_f = utils.get_config_opt(config, 'observations', 'heat_transports')
    ...
    # Plot data
    plot_streamfunctions(config, trans, basename=basename, name=name, obs=obs_sf,lw=lw)
    plot_streamfunction_hovmollers(config, trans, basename=basename, name=name, obs=obs_sf)
    plot_volume_components(config, trans, basename=basename, name=name, obs_vol=obs_vol, obs_fc=obs_fc,lw=lw)
    plot_rapid_heat_components(config, trans, basename=basename, name=name, obs=obs_oht,lw=lw)
    plot_geometric_heat_components(config, trans, basename=basename, name=name, obs=obs_oht,lw=lw)
    plot_zonal_mean_temperature(config, trans, basename=basename, name=name, obs=obs_oht,lw=lw)
    plot_transport_profile(config, trans, basename=basename, name=name, obs=obs_oht,lw=lw)
    plot_fc_transport_profile(config, trans, basename=basename, name=name, obs=obs_oht,lw=lw)
    plot_moc_vs_oht(config, trans, basename=basename, name=name, obs_vol=obs_vol, obs_oht=obs_oht)
    plot_vol_vs_heat_transports(config, trans, basename=basename, name=name, obs_vol=obs_vol, obs_oht=obs_oht)
    plot_moc_vs_oft(config, trans, basename=basename, name=name, obs_vol=None, obs_oft=None)
    plot_vol_vs_fw_transports(config, trans, basename=basename, name=name, obs_vol=None, obs_oft=None)
    plot_geometric_fw_components(config, trans, basename=basename, name=name, obs=None,lw=lw)
    plot_rapid_fw_components(config, trans, basename=basename, name=name, obs=None,lw=lw)
